...
const skills = [
    ...
    },
    {
      ...
      description: "Escritura de código con tipos seguros para una mejor mantenibilidad y experiencia del desarrollador.",
    ...
    },
    {
      ...
      description: "Optimización de aplicaciones web para velocidad, accesibilidad y visibilidad en motores de búsqueda.",
      color: "text-teal-500",
    },
    {
      icon: Workflow,
